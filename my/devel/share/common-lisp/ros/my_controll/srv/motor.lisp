...
(cl:defmethod cl:initialize-instance :after ((m <motor-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motor-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_controll-srv:<motor-request> is deprecated: use my_controll-srv:motor-request instead.")))

(cl:ensure-generic-function 'Move-val :lambda-list '(m))
(cl:defmethod Move-val ((m <motor-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_controll-srv:Move-val is deprecated.  Use my_controll-srv:Move instead.")
  (Move m))
...
(cl:defmethod cl:initialize-instance :after ((m <motor-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motor-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_controll-srv:<motor-response> is deprecated: use my_controll-srv:motor-response instead.")))
